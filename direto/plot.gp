...
plot for [i=0:5] './output/quicksort.dat' u 2:3 index i t columnhead(1) w linespoints

set title "Selection Sort - Cache Hit"
set output "./output/selection_hit.svg"
plot for [i=0:5] './output/selection.dat' u 2:3 index i t columnhead(1) w linespoints

set title "Bubble Sort - Cache Hit"
set output "./output/bubblesort_hit.svg"
plot for [i=0:5] './output/bubblesort.dat' u 2:3 index i t columnhead(1) w linespoints
...
plot for [i=0:5] './output/quicksort.dat' u 2:4 index i t columnhead(1) w linespoints

set title "Selection Sort - Cache Miss"
set output "./output/selection_miss.svg"
plot for [i=0:5] './output/selection.dat' u 2:4 index i t columnhead(1) w linespoints

set title "Bubble Sort - Cache Miss"
set output "./output/bubblesort_miss.svg"
plot for [i=0:5] './output/bubblesort.dat' u 2:4 index i t columnhead(1) w linespoints
